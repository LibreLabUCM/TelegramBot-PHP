...
class TA_File {
   ...
   public static function createFromJson($json) {
      return TA_File::createFromArray(json_decode($json));
   }
...
class TA_InlineQuery {
   ...
   private function TA_InlineQuery($id, $from, $query, $offset) {
      $this->id = $id;
      $this->from = $from;
      $this->query = $query;
      $this->offset = $offset;
...
class TA_InlineQueryResultArticle extends TA_InlineQueryResult {
   ...
   private function TA_InlineQueryResultArticle($id, $title, $message_text, $parse_mode, $disable_web_page_preview, $url, $hide_url, $description, $thumb_url, $thumb_width, $thumb_height) {
      $this->type = "article";
      $this->id = $id;
      $this->title = $title;
   ...
   public static function createFromJson($json) {
      return TA_InlineQueryResultArticle::createFromArray(json_decode($json));
   }
   
   public static function createMinimum($id, $title, $message_text) {
      return TA_InlineQueryResultArticle::createFromArray(array(
            'id' => $id,
            'title' => $title,
